...
EXPORT_SYMBOL(mem_cgroup_try_charge);//pagecacheMUK
...
EXPORT_SYMBOL(mem_cgroup_commit_charge);//pagecacheMUK
...
EXPORT_SYMBOL(mem_cgroup_cancel_charge);//pagecacheMUK
...
EXPORT_SYMBOL(mem_cgroup_migrate);//pagecacheMUK
