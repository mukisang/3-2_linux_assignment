...
//Main BST functions
void LF_add(int key, int thread_num);
int LF_find(int key, LF_BST_Node **pred, void **pred_op, LF_BST_Node **curr, void **curr_op, LF_BST_Node *auxRoot, int thread_num);
bool LF_remove(int key, int thread_num);
